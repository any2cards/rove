...
// Put longer names first, so "Canyon Temper" matches before "Canyon"
...
function loadFromStorage() {
	...
	var extdefault = {
		...
		"co": true,
		"co-base": true,
		"co-base-abilities": true,
		"co-base-allies": true,
		"co-base-classes": true,
		"co-base-items": true,
		"co-base-profile-boards": true,
		"co-base-traits": true,
		"co-prime": true,
		"co-prime-abilities": true,
		"co-prime-allies": true,
		"co-prime-classes": true,
		"co-prime-items": true,
		"co-prime-profile-boards": true,
		"co-prime-traits": true,
		"co-apex": true,
		"co-apex-abilities": true,
		"co-apex-allies": true,
		"co-apex-classes": true,
		"co-apex-items": true,
		"co-apex-profile-boards": true,
		"co-apex-traits": true,
		"xu": true,
		"xu-prime": true,
		"xu-prime-abilities": true,
		"xu-prime-allies": true,
		"xu-prime-classes": true,
		"xu-prime-items": true,
		"xu-prime-profile-boards": true,
		"xu-prime-traits": true,
		"xu-apex": true,
		"xu-apex-abilities": true,
		"xu-apex-allies": true,
		"xu-apex-classes": true,
		"xu-apex-items": true,
		"xu-apex-profile-boards": true,
		"xu-apex-traits": true,
		"gm": true,
		"gm-art": true
	}
